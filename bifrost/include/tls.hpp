...
const Bytes TOTP_HKDF_INFO(TOTP_HKDF_INFO_STR.begin(), TOTP_HKDF_INFO_STR.end());
...
// keylog, which is an intermediate key-schedule secret that Python cannot access.
constexpr std::string_view BIFROST_EXPORTER_LABEL{"bifrost-ms"};
